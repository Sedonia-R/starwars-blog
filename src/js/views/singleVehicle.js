		...
		<>
			<div className="container-fluid top-banner">
				<div className="row justify-contents-center ml-2 mr-2 bg-secondary">
					<img src={`https://starwars-visualguide.com/assets/img/vehicles/${store.vehicle.uid}.jpg`} className="col-4 picture" alt="..." />
						<div className="col-8 pt-4 pb-4 border-start border-warning">
							<h1 className="text-warning">{store.vehicle.properties.name}</h1>
			...
			<div className="row container-fluid single-details">
				...
				<div className="col text-warning border-start border-secondary">
					MANUFACTURER
					<p className="text-white">
						{store.vehicle.properties.manufacturer}
					</p>
				</div>
				<div className="col text-warning border-start border-secondary">
					COST IN CREDITS
					<p className="text-white">
						{store.vehicle.properties.cost_in_credits}
					</p>
				</div>
				<div className="col text-warning border-start border-secondary">
					LENGTH
					<p className="text-white">
						{store.vehicle.properties.length}
					</p>
				</div>
				<div className="col text-warning border-start border-secondary">
					CREW
                ...
                <div className="col text-warning border-start border-secondary">
					MAX SPEED
                    <p className="text-white">
						{store.vehicle.properties.max_atmosphering_speed}
					</p>
				</div>
			</div>
		</>
